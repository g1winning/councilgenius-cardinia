#!/usr/bin/env python3
"""
CouncilGenius V8 - Cardinia Shire Council
...
COUNCIL_DOMAIN = "www.cardinia.vic.gov.au"
COUNCIL_PHONE = "1300 787 624"
...
CATEGORIES = {
    'waste_bins': {
        'keywords': ['bin', 'collection', 'recycling', 'green waste', 'hard waste',
                     ...
                     'landfill', 'waste', 'e-waste', 'e waste', 'mattress',
                     'furniture', 'skip'],
    },
    'rates': {
    ...
    'roads': {
        'keywords': ['pothole', 'road', 'maintenance', 'street', 'tree',
                     ...
                     'vandalism', 'damaged', 'broken', 'hazard', 'safety',
                     'drain', 'flooding', 'sign'],
    },
    'parking': {
    ...
    'pets': {
        'keywords': ['pet', 'dog', 'cat', 'animal', 'registration', 'microchip',
                     'barking', 'off-lead', 'off lead', 'dangerous dog',
                     'off-leash', 'off leash', 'desex', 'de-sex'],
    },
    'property': {
    ...
    'family': {
        'keywords': ['kindergarten', 'kinder', 'childcare', 'maternal', 'immunisation',
                     'playgroup', 'family', 'children', 'youth', 'aged care',
                     'disability', 'seniors'],
    },
    'community': {
        'keywords': ['library', 'libraries', 'pool', 'community', 'centre', 'center',
                     'program', 'recreation', 'swimming', 'sport', 'venue', 'hire',
                     'leisure', 'hall', 'tourism', 'visitor', 'museum',
                     'arts', 'culture', 'events', 'volunteer'],
    },
    'food_business': {
    ...
    'contact': {
        'keywords': ['phone', 'email', 'address', 'hours', 'contact', 'office',
                     'emergency', 'after hours', 'urgent', 'open', 'closed',
                     'when', 'where'],
    },
    'environment': {
    ...
    'grants': {
        'keywords': ['grant', 'funding', 'support', 'community fund'],
    },
    'local_laws': {
        'keywords': ['local law', 'bylaw', 'burning', 'burn off', 'camping',
                     'livestock', 'noise', 'fire', 'CFA', 'burn-off'],
    },
    'forms': {
...
def classify(text):
    """V9 classify function - expanded keywords, scoring-based."""
